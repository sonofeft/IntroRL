...
from introrl.mdp_data.windy_stoich_kings_gridworld import get_env

gridworld = get_env( step_reward=-1 )

policy, state_value= \
    td0_epsilon_greedy( gridworld, 
                        ...
                        max_num_episodes=10000, min_num_episodes=10, max_abserr=0.001, 
                        gamma=1.0,
                        iteration_prints=0,
