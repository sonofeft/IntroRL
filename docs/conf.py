...
# -*- coding: utf-8 -*-
#
# IntroRL documentation build configuration file, created by
...
target_file = os.path.join( up_one, 'introrl','_version.py')
...
project = u'IntroRL'
copyright = u'2019, Charlie Taylor'
...
latex_documents = [
  (master_doc, 'IntroRL.tex', u'IntroRL Documentation',
...
man_pages = [
    (master_doc, 'projectabcxyz', u'IntroRL Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'IntroRL', u'IntroRL Documentation',
   author, 'IntroRL', 'One line description of project.',
   'Miscellaneous'),
]
